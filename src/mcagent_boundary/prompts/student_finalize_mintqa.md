Finalize-after-tool guidance for MintQA factual questions.

Purpose:
- Use the search observation to produce a concise final factual answer.
...
- If the search result is insufficient and SEARCH is still allowed, choose SEARCH with a narrower query.
